...
<?php
    ...
    $result = $mysqli->query("SELECT * FROM program") or die($mysqli->error);
    ?>
	<!--Start Home Section-->
	<div id="home">
...
<div class="admin-wrapper content my-5 border-0">
    ...
    <div class="left-sidebar my-4">
        <ul>
            ...
            <li><a href="../category/index.php">Manage Category</a></li>
    ...
    <div class="admin-content my-3">
        ...
        <div class="content my-3">
            ...
            <h2 class="page-title">Manage Programs Posts</h2>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['ProgramCategory']; ?></td>
                        <td><a href="create.php?edit=<?php echo $row['ID']; ?>" class="edit">Edit</a></td>
