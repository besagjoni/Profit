...
<?php
    ...
    $result1=  $mysqli->query ("SELECT * FROM `nutrition` WHERE `NutritionCategory`='$name_category' ") or die($mysqli->error);
...
?>
    ...
    <div class="row" id="all-nutrition">
        <div class="column left">
            ...
            <?php while ($program = $result1->fetch_assoc()): ?> 
            ...
            <div class="border-bottom"><?php while ($category = $result2->fetch_assoc()): ?> </div>
                <div class="row categories-container">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" name="kategori"><a href="kategoriN.php?name_category=<?php echo $category['Name']; ?>"><?= $category['Name'] ?></a></li>
                    </ul> 
                    <?php endwhile; ?>       
                </div>    
            </div>                 
